...
//    }
    ...
    public final void notifyObservers(ReaderEvent event){
      synchronized (readerObservers) { // TODO Ixxi a mis un verrou sans l'expliquer, s'agit de s'assurer que la liste des observer n'�volue pas lorsqu'on la parcourt?
