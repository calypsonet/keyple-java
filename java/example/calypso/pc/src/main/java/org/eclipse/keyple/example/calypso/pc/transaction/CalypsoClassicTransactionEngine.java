...
public class CalypsoClassicTransactionEngine extends AbstractReaderObserverEngine {
    ...
    public DefaultSelectionRequest preparePoSelection() {
        ...
        seSelection.prepareSelection(new PoSelectionRequest(new SeSelector(
                new SeSelector.AidSelector(ByteArrayUtils.fromHex(poFakeAid1),
         ...
         */
        PoSelectionRequest poSelectionRequestCalypsoAid = new PoSelectionRequest(new SeSelector(
         ...
         */
        seSelection.prepareSelection(new PoSelectionRequest(new SeSelector(
                new SeSelector.AidSelector(ByteArrayUtils.fromHex(poFakeAid2),
                        SeSelector.AidSelector.SelectMode.FIRST),
                null, ChannelState.KEEP_OPEN, ContactlessProtocols.PROTOCOL_B_PRIME,
                "Selector with fake AID2")));

        /*
         * Add selection case 4: ATR selection, rev 1 atrregex
         */
        seSelection.prepareSelection(new PoSelectionRequest(new SeSelector(null,
                new SeSelector.AtrFilter(CalypsoClassicInfo.ATR_REV1_REGEX), ChannelState.KEEP_OPEN,
