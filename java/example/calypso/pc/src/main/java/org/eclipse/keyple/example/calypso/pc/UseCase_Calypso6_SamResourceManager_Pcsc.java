                ...
                case READER_CONNECTED:
                    ...
                    if (reader instanceof ObservableReader) {
                        if (poReaderObserver != null) {
                            ...
                            try {
                                ReaderUtilities.setContactlessSettings(reader);
                ...
                case SE_MATCHED:
                    if (seSelection.processDefaultSelection(event.getDefaultSelectionResponse())) {
                        ...
                        PoTransaction poTransaction =
                                new PoTransaction(poReader, (CalypsoPo) selectedSe, samResource,
                        ...
                        try {
                            ...
                            ReadRecordsRespPars readEventLogParser = poTransaction
                                    .prepareReadRecordsCmd(CalypsoClassicInfo.SFI_EventLog,
