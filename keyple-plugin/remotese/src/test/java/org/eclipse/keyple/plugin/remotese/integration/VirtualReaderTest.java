...
public class VirtualReaderTest {
    ...
    public void testKOTransmitSet_NoSE() throws Exception{
        ...
        this.nativeReaderService.connectReader(nativeReader, CLIENT_NODE_ID);

        ProxyReader virtualReader = this.virtualReaderService.getPlugin().getReaders().first();
    ...
    public void rse_transmit_Hoplink_Sucessfull() throws Exception{
        ...
        //test virtual reader
        VirtualReader virtualReader = (VirtualReader) this.virtualReaderService.getPlugin().getReaders().first();
