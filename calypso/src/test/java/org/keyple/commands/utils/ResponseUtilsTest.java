...
import org.keyple.commands.dto.AID;
import org.keyple.commands.dto.EF;
...
import org.keyple.commands.dto.PostponedData;
import org.keyple.commands.dto.Ratification;
import org.keyple.commands.dto.SamChallenge;
import org.keyple.commands.dto.SamHalfSessionSignature;
import org.keyple.commands.dto.SecureSession;
import org.keyple.commands.dto.StartupInformation;
import org.keyple.commands.dto.TransactionCounter;
...
public class ResponseUtilsTest {
    ...
    public void TestToFCI() {
        ...
        FCI fciExpected = new FCI(aidExpected.getValue(), fciProprietaryTemplate, fciIssuerDiscretionaryData,
                applicationSN, startupInfoExpected);
    ...
    public void TestToPOHalfSessionSignature() {
        ...
        // Case Length = 4
        POHalfSessionSignature poHalfSessionSignatureExpected = new POHalfSessionSignature(sessionSignature, null);
